                ...
                <div id="flFormsGrid" class="col-lg-12 layout-spacings">
                    <div class="statbox widget box box-shadow">
                        ...
                        <div class="widget-content">
                            <!-- charges List Div -->
                            <div class="layout-px-spacing profil" id="charges-list">
                                <div class="row layout-top-spacing">
                                    <div id="flFormsGrid" class="col-lg-12 layout-spacing">
                                        <div class="statbox widget box box-shadow">
                                            <div class="widget-header">
                                                ...
                                                <div class="row">
                                                    <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                                        <h4>List Of Charge Plan</h4>
                                                    </div>
                                                </div>

                                            </div>
                                            <div class="widget-content widget-content-area">
                                                <table id="chargesTable" class="table table-hover non-hover"
                                                    style="width:100%">
...
$(document).ready(function() {
    ...
    // Fetch Chargess Details
    var charges_table = $('#chargesTable').DataTable({
...
function removeCharge(id) {
    let _url = `charges/${id}`;
    if (confirm("Are You sure want to remove this Charge Plan!") == true) {
        ...
        $.ajax({
            ...
            success: function(response) {
                swal({
                    title: "Success",
                    text: "Charge Plan Successfully Removed",
                    icon: "success",
                    button: "OK"
                });
